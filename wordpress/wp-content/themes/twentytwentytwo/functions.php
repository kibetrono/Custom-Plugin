...
// start of creating a custom post type
...
function my_first_custom_post_type(){
    ...
    $args=array(
        ...
        'public'=>true,
        'has_archieve'=>true,
        // 'menu_icon'=> '',    for changing icons
        'supports'=>array('title','editor','thumbnail'),
        're-write'=>array('slug','my-countries')
    );
...
// end of creating a custom post type


// start of creating a taxonomy
...
function my_first_taxonomy(){
    ...
    register_taxonomy('continents',array('countries'),$args);
}

add_action('init','my_first_taxonomy');
// end of creating a taxonomy
